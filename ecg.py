...
def _extract_heartbeats(signal=None, rpeaks=None, before=200, after=400):
    ...
    for r in R:
        ...
        newR.append(r)
        # N_Hearts.append(signal[a:b])
        # A_Hearts.append(signal[a:b])
        # O_Hearts.append(signal[a:b])
        # others_Hearts.append(signal[a:b])
    templates = np.array(templates)
    newR = np.array(newR, dtype='int')
    S.append(len(templates))
